...
The dataset is generated by `scripts/generate_code.py` into `data/exp_instances/`
using the scenario matrix below.

*   **Fleet Size ($n_C$):** $n_C=80$ for S2 and S4; $n_C=100$ otherwise.
...
| :--- | :--- | :--- |
| **Load** | $n_K : n_C$ | Testing the system from low demand (1:3) to very heavy overload (10:1). |
...
| `data/scenario_study_128/scenario_gap_summary.csv` | Larger robustness study summary. |
| `data/scenario_study_128/optimal_gap_histograms_combined.svg` | Combined histogram plot for the 128-instance study. |
